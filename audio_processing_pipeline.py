...
def ai_pipeline(base_dir, filename):
    ...
    audio_path_file = os.path.join(base_dir, os.path.join('input', filename)) # audio
    ...
    # run model
    text, words_timestamp = asr_model(audio_path_file)
    # save transcript
    ...
    mute_segments(audio_path_file, mute_segments_list, beep_aud_dir+"beep.wav")
